...
public class MyDonutProgress extends View {
    ...
    private static final String INSTANCE_SUB_TEXT = "text";
    ...
    public MyDonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_sub_text_size = DisplayUtils.sp2px(getResources(), 12);
        min_size = (int) DisplayUtils.dp2px(getResources(), 100);
        default_stroke_width = DisplayUtils.dp2px(getResources(), 10);
        default_inner_bottom_text_size = DisplayUtils.sp2px(getResources(), 18);
        default_text_margin = DisplayUtils.dp2px(getResources(), 10);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        subTextColor = attributes.getColor(R.styleable.DonutProgress_donut_sub_text_color, default_sub_text_color);
        subTextSize = attributes.getDimension(R.styleable.DonutProgress_donut_sub_text_size, default_sub_text_size);
        subText = attributes.getString(R.styleable.DonutProgress_donut_sub_text);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            float subTextHeight = subTextPaint.descent() + subTextPaint.ascent();

            canvas.drawText(text, (getWidth() - textPaint.measureText(text)) / 2.0f, (getWidth() - textHeight + subTextHeight) / 2.0f, textPaint);
            if (!TextUtils.isEmpty(subText)) {
                canvas.drawText(subText, (getWidth() - subTextPaint.measureText(subText)) / 2.0f, (getWidth() - textHeight - subTextHeight + default_text_margin) / 2.0f, subTextPaint);
            }
        }
